...
class GameFragment : Fragment() {
    ...
    //Чтобы избежать крашей, мы до создания view - обьявили ее до создания view и после view
    // Таким образом к binding можно образаться только когда она существует
